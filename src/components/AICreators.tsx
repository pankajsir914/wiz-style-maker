...
const AICreators = () => {
  ...
  return (
    <section className="py-10 sm:py-20 px-4 sm:px-6 md:px-12 lg:px-24">
      <motion.div
        ref={ref}
        initial="hidden"
        animate={controls}
      ...
      >
        ...
        <Card className="bg-gradient-to-br from-background via-background to-primary/5 border-border/50 backdrop-blur-sm p-4 sm:p-8 md:p-12">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    <feature.icon className="w-5 sm:w-6 h-5 sm:h-6 text-primary" />
                  </div>
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-sm sm:text-lg mb-1 sm:mb-2 text-foreground">
                    {feature.title}
                  </h3>
          ...
          >
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-primary text-primary-foreground rounded-full text-sm sm:text-base font-medium hover:bg-primary/90 transition-all hover:scale-105"
            >
