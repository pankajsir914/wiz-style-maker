          ...
          <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 lg:gap-16">
            {[
              ...
              <motion.div
                ...
                className="flex items-center justify-center w-20 h-16 sm:w-28 sm:h-20 md:w-32 md:h-24"
              >
                <img 
                  src={partner.logo} 
                  alt={partner.name}
                  className="max-w-full max-h-full object-contain drop-shadow-lg hover:drop-shadow-2xl transition-all duration-300"
                />
              </motion.div>
            ))}
          </div>
